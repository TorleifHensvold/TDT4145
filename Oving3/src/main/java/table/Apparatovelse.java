...
public class Apparatovelse extends Ovelse
{
	...
	// DONE: create a constructor that can create an instance with only getting
	// the variables that has to be not null
	 ...
	 * 
	 * public void setOvelsesID(int ovelsesID) throws Exception{ //TODO: check
	 * that ovelsesID doesn't exist in apparatovelse, and check that there
	 * exists a ovelse with this ovelsesID as it is foreign key if (ovelsesID <=
	 * 1000000000) { this.OvelsesID=ovelsesID; } else { throw new
	...
	/*
	 * public void databaseSetOvelsesID(int ovelsesID) { this.OvelsesID =
	 * ovelsesID; }
	 */
